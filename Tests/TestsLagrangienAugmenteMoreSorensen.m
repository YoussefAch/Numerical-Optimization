...
[x, lambdak, muk, k] = LagrangienAugmente(f1, grad_f1, H_f1, c1, Jc1, H_c1, mu0, tau, eta0t, alpha, beta, epsilon0, eta0, x01, lambda0, 100, 'MoreSorensen');
...
[x, lambdak, muk, k] = LagrangienAugmente(f1, grad_f1, H_f1, c1, Jc1, H_c1, mu0, tau, eta0t, alpha, beta, epsilon0, eta0, x02, lambda0, 100, 'MoreSorensen');
disp(['Valeur de x = ','[',num2str(x(1)),';',num2str(x(2)),';',num2str(x(3)),']']);
disp(['Nombre iterations : ',num2str(k)]);
disp(['Valeur de lambdak = ', num2str(lambdak)]);
disp(['Valeur de muk = ',num2str(muk)]);
...
[x, lambdak, muk, k] = LagrangienAugmente(f2, grad_f2, H_f2, c2, Jc2, H_c2, mu0, tau, eta0t, alpha, beta, epsilon0, eta0, x01, lambda0, 100, 'MoreSorensen');
...
[x, lambdak, muk, k] = LagrangienAugmente(f2, grad_f2, H_f2, c2, Jc2, H_c2, mu0, tau, eta0t, alpha, beta, epsilon0, eta0, x02, lambda0, 100, 'MoreSorensen');
disp(['Valeur de x = ','[',num2str(x(1)),';',num2str(x(2)),']']);
disp(['Nombre iterations : ',num2str(k)]);
disp(['Valeur de lambdak = ', num2str(lambdak)]);
disp(['Valeur de muk = ',num2str(muk)]);
