...
disp('---------- Tests de Region de Confiance ----------');
...
[x, minf, ngsol, nbIter, nevals, flag] = RegionConfiance(f1, grad_f1, H_f1, x011, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
...
[x, minf, ngsol, nbIter, nevals, flag] = RegionConfiance(f1, grad_f1, H_f1, x012, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x021, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x022, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x023, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x024, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x025, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
...
disp('--');
disp('-------- Test pour la valeur initiale [2; 2]');
[x, minf2, ngsol, nbIter, nevals, flag] = RegionConfiance(f2, grad_f2, H_f2, x026, epsilon, delta0, deltaMax, gamma1, gamma2, eta1, eta2, nbIterMax, 'Cauchy');
if (flag == 0)
    disp(['algo de Region de Confiance a converge en ', num2str(nbIter), ' iteration(s).']);
elseif (flag == 1)
    disp(['Stagnation sur x ', num2str(nbIter), ' iteration(s).']);
